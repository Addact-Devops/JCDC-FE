...
(function () {
    ...
    function init() {
        ...
        function getParams() {
            ...
            const page = isNaN(pageRaw) || pageRaw < 1 ? 1
                       : pageRaw > TOTAL_PAGES ? TOTAL_PAGES
                       : pageRaw;
            return { q, page };
        }
        ...
        function renderPagination(current, total, query) {
            ...
            ordered.forEach((n) => {
                if (n - prev > 1) {
                    parts.push(`<li class="pagination__item"><span class="pagination__btn pagination__btn--ellipsis" aria-hidden="true">…</span></li>`);
                }
