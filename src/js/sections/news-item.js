...
(function () {
    ...
    const MOCK_ITEMS = [
        { id: 'jc-12bn-contract',   image: 'https://images.unsplash.com/photo-1497366216548-37526070297c?w=800&q=85', date: '2024-02-05', i18nKey: 'newsListing.items.0', category: 'companyUpdates' },
        { id: 'efqm-recognition',   image: 'https://images.unsplash.com/photo-1573164574572-cb89e39749b4?w=800&q=85', date: '2023-10-12', i18nKey: 'newsListing.items.1', category: 'communityEvents' },
        { id: 'global-pm-forum',    image: 'https://images.unsplash.com/photo-1591115765373-5207764f72e7?w=800&q=85', date: '2023-06-12', i18nKey: 'newsListing.items.2', category: 'awardsRecognition' },
        { id: 'cityscape-global',   image: 'https://images.unsplash.com/photo-1520637836862-4d197d17c55a?w=800&q=85', date: '2023-09-13', i18nKey: 'newsListing.items.3', category: 'projectMilestones' },
        { id: 'efqm-diamond-member',image: 'https://images.unsplash.com/photo-1556761175-5973dc0f32e7?w=800&q=85', date: '2023-04-02', i18nKey: 'newsListing.items.4', category: 'projectMilestones' },
        { id: 'corinthia-mou',      image: 'https://images.unsplash.com/photo-1542744173-8e7e53415bb0?w=800&q=85', date: '2023-03-30', i18nKey: 'newsListing.items.5', category: 'projectMilestones' },
        { id: 'q1-progress',        image: 'https://images.unsplash.com/photo-1486406146926-c627a92ad1ab?w=800&q=85', date: '2024-04-15', i18nKey: 'newsListing.items.6', category: 'companyUpdates' },
        { id: 'green-buildings',    image: 'https://images.unsplash.com/photo-1518005020951-eccb494ad742?w=800&q=85', date: '2024-05-20', i18nKey: 'newsListing.items.7', category: 'projectMilestones' },
        { id: 'community-day',      image: 'https://images.unsplash.com/photo-1517457373958-b7bdd4587205?w=800&q=85', date: '2024-06-08', i18nKey: 'newsListing.items.8', category: 'communityEvents' }
    ];
    ...
    function init() {
        ...
        function render(translations, lang) {
            ...
            articleEl.innerHTML = paragraphs.map(p =>
                `<p class="news-item__paragraph">${escapeHtml(p)}</p>`
            ).join('');
